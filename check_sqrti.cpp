...
int check_sqrti::show_fnl_weirdo(int v_log,int auto_v,int st_th){
   cout<<"\n";
...
int check_sqrti::show_xpl(long double mynmb,int preci,int v_log,int st_th){
   int olp=0;
  if(v_log==1){
...
int check_sqrti::show_xl(long double mynmb,int preci,int v_log,int st_th){
